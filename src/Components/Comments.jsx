// src/InfiniteCarousel.js

import React from 'react';
import './comments.css';
import arrow from '../assets/arrow-down.svg'; // İstifadə olunan ox şəkli

// Rəylər üçün nümunə məlumatlar
const testimonials = [
  {
    id: 1,
    name: 'Quliyev Rəsul',
    ...
    date: '02 İyun 2025',
    rating: 5,
    image: 'https://via.placeholder.com/100' // Real şəkil URL-i
  },
  {
    id: 2,
    name: 'Leyla Səfər',
...
const Comments = () => {
  // Sonsuz effekt üçün rəylər siyahısını iki dəfə birləşdiririk
  ...
  return (
    <section className="testimonial-section">
      ...
      {/* Sürüşən karusel üçün konteyner */}
